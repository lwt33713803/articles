...
1. 与lottie动画比较优劣在哪里？
   ...
   这里有篇文章正好比较了两者 [文章地址](https://bootcamp.uxdesign.cc/rive-or-lottie-4caf25bb2210)

   最后结论如下：

   如果你需要的是一些简单几何图形动画，最后使用LOTTIE，lottie有庞大社区支持，可以很好的找到相应的资源。比如：页面过渡动画，用户登录页面动画等

   相应的，如果你的产品对动画比较在意，可能会涉及到复杂的动画操作，那么rie是更好的选择。
